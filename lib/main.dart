    ...
    setState(() {
      _markers.add(
          Marker(
            ...
            markerId: MarkerId('my_place'),
            position: myplace.target,
             ...
             child: TextField(
               decoration: InputDecoration(
                 ...
                 suffixIcon: IconButton(
                   ...
                   iconSize: 30.0,
                   onPressed: () async{
                     if(searchAddress?.isEmpty??true)return;

                     print(searchAddress);
                     try {
                       List<Location> locations = await locationFromAddress(searchAddress!);
                       Location newPlace = locations[0];
                       setMarkerAndMoveCamera(Position(longitude: newPlace.longitude, latitude: newPlace.latitude, timestamp: DateTime.now(), accuracy: 100, altitude: 100, altitudeAccuracy: 100, heading: 0.0, headingAccuracy: 100, speed: 0.0, speedAccuracy: 100));
                     }catch(e){
                       print(e);
                     }
                   } ,
